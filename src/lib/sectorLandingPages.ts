...
export const sectorPages: Record<string, SectorPageContent> = {
  takeaway: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. Those are core parts of the system.",
      },
      {
  ...
  cafe: {
    ...
    heroImageSrc: "/images/sectors/cafe.jpg",
    heroImageAlt:
    ...
    faqs: [
      {
        ...
        answer:
          "Yes. It is built to be simple and easy to manage.",
      },
      {
  ...
  restaurant: {
    ...
    heroImageSrc: "/images/sectors/restaurant.jpg",
    heroImageAlt:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. Visibility is a major part of the value.",
      },
      {
        question: "Can multiple staff use it?",
        answer:
          "Yes. It is built around team use and operational records.",
      },
      {
  ...
  fishAndChips: {
    ...
    heroImageSrc: "/images/sectors/fish-and-chips.jpg",
    heroImageAlt:
    ...
    builtForTitle: "Designed for independent chippies and multi-site fish & chip shops",
    builtForBody:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. Temperature logging is a core part of the platform.",
      },
      {
        question: "Is it suitable for owner-operated shops?",
        answer:
          "Yes. It is built to stay simple enough for small teams.",
      },
      {
        question: "Can I use it across more than one shop?",
        answer:
          "Yes. Multi-location use is supported.",
      },
      {
        question: "Does it help replace paper cleaning records?",
        answer:
          "Yes. Cleaning records are one of the main use cases.",
      },
    ],
  },
  ...
  pub: {
    ...
    heroImageSrc: "/images/sectors/pub.jpg",
    heroImageAlt:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. It gives a clearer record of what has been completed.",
      },
      {
      ...
      },
      {
        question: "Does it help with allergen records?",
        answer:
          "Yes. Allergen workflows are part of the platform.",
      },
      {
        question: "Can pub groups use it across sites?",
        answer:
          "Yes. TempTake supports multiple locations.",
      },
    ],
  },
  ...
  mobileCatering: {
    ...
    heroImageSrc: "/images/sectors/mobile-catering.jpg",
    heroImageAlt:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. That is one of the main advantages for mobile operators.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes. It is not just for temperature logging.",
      },
      {
        question: "Is it suitable for event caterers as well as food trucks?",
        answer:
          "Yes. It works for a wide range of mobile food businesses.",
      },
    ],
  },
};