// src/app/client-landing.tsx  ← CLEAN, STATIC, PROFESSIONAL, MOBILE-PERFECT
"use client";
...
export default function ClientLanding() {
  return (
    <>
      {/* TALLY SCRIPT — ADD ONCE IN layout.tsx <head> */}
      {/* <script src="https://tally.so/widgets/embed.js" async></script> */}

      <section className="relative min-h-screen flex flex-col items-center justify-between px-6 pt-20 pb-32 bg-gradient-to-br from-orange-50 to-amber-50">
        ...
        <div className="w-full max-w-md text-center space-y-10 z-10">
          ...
          {/* MAIN CTA — TEXT NOW PERFECT SIZE, NO ANIMATION */}
          <button
          ...
          >
            <div className="relative">
              {/* Removed pulse ring */}
              <div className="relative px-8 py-8 bg-white rounded-full border-[14px] border-orange-500 shadow-2xl">
                {/* Smaller, cleaner text */}
                <div className="text-orange-600 text-2xl sm:text-3xl font-black leading-tight text-center">
                  Lifetime Free Access
                </div>
              </div>

              {/* Static badge — no bounce */}
              <div className="absolute -top-8 -right-8 flex h-16 w-16 items-center justify-center rounded-full bg-yellow-400 shadow-2xl border-4 border-white">
          ...
          {/* Social proof */}
          <div className="space-y-8 text- text-full text-lg font-bold">
        ...
        >
          <div className="relative">
            {/* Removed ping */}
            <div className="flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-orange-600 to-red-600 shadow-2xl">
              <Plus className="h-12 w-12 text-white" />
            </div>
            {/* Static badge */}
            <div className="absolute -top-4 -right-4 flex h-14 w-14 items-center justify-center rounded-full bg-yellow-400 shadow-xl border-4 border-white">
