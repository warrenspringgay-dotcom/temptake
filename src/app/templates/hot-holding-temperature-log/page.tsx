...
export const metadata = {
  title: "Hot Holding Temperature Log Sheet (Free Download) | TempTake",
  description:
    "Download a free hot holding temperature log sheet for restaurants, takeaways and catering businesses. Record hot hold temperatures, corrective action and staff initials in a printable format.",
};

const rows = Array.from({ length: 14 }).map((_, i) => ({ id: i + 1 }));

export default function HotHoldingTemperatureLogPage() {
  return (
        ...
        <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600">
              A printable hot holding temperature log sheet for restaurants,
              takeaways and catering businesses. Record hot hold temperatures,
              corrective action and staff initials in a simple format that is
              easy to use during service.
            </p>

            <TemplateActions
              pdfHref="/downloads/hot-holding-temperature-log.pdf"
              printHref="/templates/hot-holding-temperature-log/print"
            />
          </div>
        </div>
      </section>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white shadow-sm">
            <div className="border-b border-slate-200 px-6 py-5">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">
                This is the actual hot holding temperature record layout. It is
                built to be quick to fill in during service, which is the only
                time anyone ever remembers these sheets exist.
              </p>
            </div>

            <div className="overflow-x-auto p-6">
              <div className="min-w-[1200px] rounded-2xl border border-slate-300 bg-white shadow-sm">
                <HotHoldingLogSheet rows={rows} />
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-6 lg:grid-cols-[1fr_340px]">
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-4 space-y-4 text-base leading-7 text-slate-600">
                <p>
                  Hot holding checks help prove food has stayed at a safe
                  temperature after cooking. That matters for bain maries, hot
                  cabinets, hot hold shelves and any other setup where food is
                  sitting ready for service.
                </p>

                <p>
                  A proper log sheet makes it clear what was checked, what the
                  actual reading was, whether it passed and what was done if it
                  did not.
                </p>
              </div>
            </div>
            ...
            <aside className="space-y-6">
              ...
              <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-600">
                  TempTake lets you record hot holding checks digitally, track
                  missed logs and keep food safety records without relying on
                  paper sheets that vanish the second someone cleans the pass.
                </p>
...
function HotHoldingLogSheet({ rows }: { rows: Array<{ id: number }> }) {
  return (
    <div className="bg-white p-4 text-slate-900 sm:p-6">
      <div className="mx-auto w-full max-w-[1400px]">
        <PreviewBrandHeader title="Hot Holding Temperature Log Sheet" />
        ...
        <div className="overflow-hidden border border-slate-700">
          ...
          >
            <Header>Time</Header>
            <Header>Item / Unit</Header>
            <Header>Target Temp</Header>
            <Header>Actual Temp</Header>
          ...
          {rows.map((row, index) => (
            ...
            >
              <Cell />
              <Cell />
              <Cell defaultText="63°C+" centered />
              <Cell />
              <Cell />
              <Cell />
              <Cell />
