...
export default async function FoodCoolingLogPrintPage({
  searchParams,
}: PrintPageProps) {
    ...
    <main className="min-h-screen bg-white p-4 text-slate-900 print:min-h-0 print:bg-white print:p-0">
      ...
      <div className="mx-auto w-full max-w-[1400px] print:max-w-none">
        <section className="print:break-after-page">
          <PrintBrandHeader title="Food Cooling Log Sheet" />
          ...
          <div className="overflow-hidden border border-slate-700">
            <div
              ...
              style={{
                gridTemplateColumns:
                  "80px 170px 95px 85px 95px 85px 75px 1.1fr 70px",
              }}
            >
              <Header>Date</Header>
...
function Cell() {
  return (
    <div className="min-h-[28px] border-r border-t border-slate-700 px-2 py-1.5 last:border-r-0" />
  );
}
